...
const DashboardDrawer = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <Box sx={{ display: "flex", backgroundColor: "#F0F3F4", height: "100vh" }}>
      <AppBar
        position="fixed"
        sx={{
          ...
          >
            <Stack direction="column">
              ...
              <Typography
                variant="h6"
                noWrap
                sx={{ color: "secondary.main", fontFamily: "Chillax" }}
              >
                Welcome to TouhidCodes Dashboard
              </Typography>
            </Stack>

            <Stack direction="row" gap={3} alignItems="center">
              <Avatar alt={"name"} src={"/assets/me/touhid.jpg"} />
              <AuthButton />
              {/* <AccountMenu /> */}
            </Stack>
          </Box>
